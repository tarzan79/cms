...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortainerApi.RegistrySubset = factory(root.PortainerApi.ApiClient);
  }
  ...
  /**
   * The RegistrySubset model module.
   * @module model/RegistrySubset
   * @version 1.19.2
   */

  /**
   * Constructs a new <code>RegistrySubset</code>.
   * @alias module:model/RegistrySubset
   * @class
   */
  ...
  /**
   * Constructs a <code>RegistrySubset</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RegistrySubset} obj Optional instance to populate.
   * @return {module:model/RegistrySubset} The populated <code>RegistrySubset</code> instance.
   */
