...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.PortainerApi.Status = factory(root.PortainerApi.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('EndpointManagement')) {
        obj['EndpointManagement'] = ApiClient.convertToType(data['EndpointManagement'], 'Boolean');
      }
   ...
   * @member {Boolean} EndpointManagement
   */
  exports.prototype['EndpointManagement'] = undefined;
  /**
