...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GenericError', 'model/TeamMembership', 'model/TeamMembershipCreateRequest', 'model/TeamMembershipListResponse', 'model/TeamMembershipUpdateRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GenericError'), require('../model/TeamMembership'), require('../model/TeamMembershipCreateRequest'), require('../model/TeamMembershipListResponse'), require('../model/TeamMembershipUpdateRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.PortainerApi) {
      root.PortainerApi = {};
    }
    root.PortainerApi.TeamMembershipsApi = factory(root.PortainerApi.ApiClient, root.PortainerApi.GenericError, root.PortainerApi.TeamMembership, root.PortainerApi.TeamMembershipCreateRequest, root.PortainerApi.TeamMembershipListResponse, root.PortainerApi.TeamMembershipUpdateRequest);
  }
}(this, function(ApiClient, GenericError, TeamMembership, TeamMembershipCreateRequest, TeamMembershipListResponse, TeamMembershipUpdateRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/TeamMembershipCreateRequest} body Team membership details
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/TeamMembershipListResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/TeamMembershipListResponse}
     */
    this.teamMembershipList = function(callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = TeamMembershipListResponse;
     ...
     * @param {module:model/TeamMembershipUpdateRequest} body Team membership details
