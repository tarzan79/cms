...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TLSConfiguration'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TLSConfiguration'));
  } else {
    // Browser globals (root is window)
    if (!root.PortainerApi) {
      root.PortainerApi = {};
    }
    root.PortainerApi.EndpointSubset = factory(root.PortainerApi.ApiClient, root.PortainerApi.TLSConfiguration);
  }
}(this, function(ApiClient, TLSConfiguration) {
  'use strict';
  ...
  /**
   * The EndpointSubset model module.
   * @module model/EndpointSubset
   * @version 1.19.2
   */

  /**
   * Constructs a new <code>EndpointSubset</code>.
   * @alias module:model/EndpointSubset
   * @class
   */
  ...
  /**
   * Constructs a <code>EndpointSubset</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EndpointSubset} obj Optional instance to populate.
   * @return {module:model/EndpointSubset} The populated <code>EndpointSubset</code> instance.
   */
